...
> **2026-07-20 纠偏**：本文记录的状态弹窗 `opacity-to 0` / 120ms close fade 后经用户实机确认属于退出动效回归，不再是当前产品语义。现行修复与根因见 [R15 follow-up](R15-followup-topbar-popup-close-2026-07-20.md)。本文其余内容保留为当时的历史验收记录。
