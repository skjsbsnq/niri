...
> **历史状态：实机复验未通过。** 本文记录的是第一次修复及当时的自动化结果，不能再作为最终验收结论。2026-07-10 的逐帧复核确认 `pop-slide`、激进窗口 shader 和 restore 缓动仍有可见缺陷；最终方案与新验证结果见 [T04-fix2-animations-2026-07-10.md](T04-fix2-animations-2026-07-10.md)。
