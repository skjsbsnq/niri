...
Item {
    ...
    property var glassMaterials: ({
        "panel":    { edge_highlight: 0.10, refraction: 0.003, inner_shadow: 0.12, chromatic: 0.0, lens_depth: 0.0 },
        "pill":     { edge_highlight: 0.24, refraction: 0.009, inner_shadow: 0.10, chromatic: 0.0, lens_depth: 0.006 },
        "launcher": { edge_highlight: 0.11, refraction: 0.003, inner_shadow: 0.12, chromatic: 0.0, lens_depth: 0.001 },
        "dock":     { edge_highlight: 0.13, refraction: 0.005, inner_shadow: 0.12, chromatic: 0.0, lens_depth: 0.003 },
        "menu":     { edge_highlight: 0.18, refraction: 0.003, inner_shadow: 0.13, chromatic: 0.0, lens_depth: 0.0 },
        "toast":    { edge_highlight: 0.18, refraction: 0.004, inner_shadow: 0.12, chromatic: 0.0, lens_depth: 0.0 },
