...
- Phase 5 follow-up bumps the surface interface to v3 with `material_alpha` (`TahoeGlassRegion.materialAlpha` in QML). It fades compositor material/shadow alpha for enter/exit transitions while keeping region geometry fixed.
