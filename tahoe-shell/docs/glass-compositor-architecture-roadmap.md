...
| Phase 1：拆 namespace，移除 broad layer rule | 下一步 | 先切断 `namespace="^quickshell"` 对所有 Quickshell surface 的误伤。 |
| Phase 2：niri blurRegion bbox 过渡修复 | 待做 | 在私有协议完成前，先让大透明 layer 内的小玻璃使用自己的 bbox 坐标。 |
