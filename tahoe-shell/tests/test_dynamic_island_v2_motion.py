...
class DynamicIslandV2MotionTests(unittest.TestCase):
    ...
    def test_overlay_geometry_uses_v2_not_legacy_380(self) -> None:
        ...
        # the surface/region read clamped driver output. T25 retired the third
        # SpringAnimation (T24 mediaContentMorphSpring): the media path now
        # bypasses the compositor morph and mediaExpandProgress is back to a
        # readonly height-binding, so the R08 region-leave guard holds at 2
        # geometry springs.
